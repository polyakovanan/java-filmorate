...
@SpringBootTest(classes = {FilmController.class, UserController.class, FilmController.class, InMemoryUserStorage.class, UserService.class, RecommendationService.class, ReviewController.class, FilmService.class, UserService.class, ReviewService.class, InMemoryFilmStorage.class, InMemoryUserStorage.class, InMemoryFriendshipStorage.class, InMemoryGenreStorage.class, InMemoryMPARatingStorage.class, InMemoryLikeStorage.class, InMemoryEventStorage.class, InMemoryReviewStorage.class, ApplicationContext.class})
